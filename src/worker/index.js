...
var moderateTextWithAI = function (name, message, env) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                hasUserText = ((name === null || name === void 0 ? void 0 : name.trim()) && name !== "Anonymous") || (message === null || message === void 0 ? void 0 : message.trim());
                if (!hasUserText) {
            ...
            case 1:
                response = _a.sent();
                aiText = (response === null || response === void 0 ? void 0 : response.response) || "";
...
var moderateImageWithAI = function (imageBlob, env) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                buf = _a.sent();
                b64 = node_buffer_1.Buffer.from(buf).toString("base64");
            ...
            case 2:
                response = _a.sent();
                aiRaw = (response === null || response === void 0 ? void 0 : response.response) || response;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                width = parseInt(formData.get("width") || "0", 10);
                height = parseInt(formData.get("height") || "0", 10);
    ...
    return __generator(this, function (_h) {
        switch (_h.label) {
            case 0:
                ...
                limit = parseInt((_d = url.searchParams.get("limit")) !== null && _d !== void 0 ? _d : "", 10) || 12;
                offset = parseInt((_f = url.searchParams.get("offset")) !== null && _f !== void 0 ? _f : "", 10) || 0;
                sinceId = parseInt((_g = url.searchParams.get("since_id")) !== null && _g !== void 0 ? _g : "", 10);
                checkIds = url.searchParams.get("check_ids");
                query = void 0, countQuery = void 0, params = void 0;
                checkedPhotos = [];
    ...
    return __generator(this, function (_g) {
        switch (_g.label) {
            case 0:
                ...
                return [4 /*yield*/, request.json()];
            case 1:
                _a = _g.sent(), imageID = _a.imageID, action = _a.action, ids = _a.ids;
            ...
            case 9:
                _i++;
                return [3 /*break*/, 5];
            case 10: return [4 /*yield*/, (_f = env.DB.prepare("DELETE FROM photos WHERE id IN (".concat(placeholders, ")")))
                    .bind.apply(_f, targetIds).run()];
            case 11:
                _g.sent();
